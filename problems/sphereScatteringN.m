...
%| Creation   : 14.03.17                                                  |
%| Last modif : 21.06.17                                                  |
%| Synopsis   : Solve boundary element neumann problem, Hypersingular     |
%+========================================================================+
...
tic
LHS = 1/(4*pi) .* (k^2 * integral(bnd,bnd,ndot(u),Gxy,ndot(v),tol) ...
    - integral(bnd,bnd,nxgrad(u),Gxy,nxgrad(v),tol));
toc
